...
public class XMLSchemaValidator extends AbstractMediator {
    ...
    public boolean mediate(MessageContext messageContext) {
        ...
        if (contentTypeObject != null) {
            ...
            contentType = axis2MC.getProperty(ThreatProtectorConstants.EXTERNAL_CONTENT_TYPE).toString();
        }
    ...
    XMLConfig configureSchemaProperties(MessageContext messageContext) {
        ...
        if (log.isDebugEnabled()) {
            log.debug(String.format("DTD enable:" + dtdEnabled) + ", " + "External entities: " + externalEntitiesEnabled
