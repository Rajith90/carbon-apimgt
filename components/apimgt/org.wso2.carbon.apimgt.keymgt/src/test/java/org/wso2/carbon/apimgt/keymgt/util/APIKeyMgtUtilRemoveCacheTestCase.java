...
public class APIKeyMgtUtilRemoveCacheTestCase {
    @Before
    public void init() {
    ...
    @Test
    public void testRemoveFromKeyManagerCache() {
        ...
        APIKeyMgtUtil.removeFromKeyManagerCache(sampleCacheKey);
        Mockito.verify(mockedCache,Mockito.atLeastOnce()).remove(Mockito.anyString());
    }
}