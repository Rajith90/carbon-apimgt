...
public class APIMWSDLUpdateTest {
    ...
    public void testUpdateWsdl() throws Exception {
        ...
        OMElement element = apimwsdlReader.updateWSDL(byteArray, api);
    ...
    public void testUpdateWsdl2() throws Exception {
        ...
        PowerMockito.when(APIUtil.buildOMElement(Mockito.any(ByteArrayInputStream.class))).thenReturn(omElement);
        APIMWSDLReader apimwsdlReader = new APIMWSDLReader("http://localhost.com/");
        OMElement actualOmElement = apimwsdlReader.updateWSDL2(byteArray, api);
        Assert.assertNotNull(actualOmElement);
    }
